...
public class HoeffdingTree extends AbstractClassifier implements MultiClassClassifier,
    ...
    public FlagOption stopDepthManagementOption = new FlagOption(
            "stopDepthManagement", 'S',
            "Stop growing as soon as depth limit is hit.");
    ...
    protected boolean maxDepthAllowed;
    ...
    public void estimateModelDepth() {
    	int actualTreeDepth = this.measureTreeDepth();
    	if (this.stopDepthManagementOption.isSet() && actualTreeDepth > this.maxDepthOption.getValue()) {
    		this.growthAllowed = false;
    	}    	
    }
