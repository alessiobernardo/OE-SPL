...
/**
 * OnlineEnsembleSpacedLearning
 *
 * <p>Oversampling (faster learning) until the base learner trees are still learning, 
 * undersampling (stop learning) when the base learner trees are not growing anymore, and
 * Spaced Learning heuristic to resume the learning phase over time.</p>
 *
 * <p>See details in:<br>Alessio Bernardo, Emanuele Della Valle, Albert Bifet. 
 *  Choosing the Right Time to Learn Evolving Data Streams
 *  2023 IEEE International Conference on Big Data (Big Data). IEEE, 2023. (To Appear) </p>
 *
 * <p>Parameters:</p> <ul>
 * <li>-l : Base learner to train (only tree)</li>
 * <li>-S : The number of tree base learners in the ensemble</li>
 * <li>-L : Max lambda value to use in Poisson distribution</li>
 * <li>-e : Seed value</li>
 * <li>-x : The change detector strategy to use for drifts</li>
 * <li>-m : Maximum memory consumed by the tree base learners</li>
 * <li>-d : Maximum depth of the tree base learners</li>
 * <li>-s : Every how many examples use Page Hinkley statistical test to check whether 
 * 			the base learner trees are statistically growing</li>
 * <li>-a : For how many samples to apply the Spaced Learning heuristic</li>
 * <li>-r : Should reset a tree base learner after a drift detection?</li>
 * </ul>
 *
 * @author Alessio Bernardo (alessio dot bernardo at polimi dot it)
 * @version $Revision: 1 $
...
public class OESPL extends AbstractClassifier implements MultiClassClassifier,CapabilitiesHandler {

    @Override
    public String getPurposeString() {
        return "Oversampling (faster learning) until the base learner trees are still learning, \n"
        		+ "undersampling (stop learning) when the base learner trees are not growing anymore, \n"
        		+ "and Spaced Learning heuristic to resume the learning phase over time.";
    }
    
    private static final long serialVersionUID = 1L;
    
    public ClassOption baseLearnerOption = new ClassOption("baseLearner", 'l',
            "Base learner to train.", Classifier.class, "trees.HoeffdingTree -S");  
    
    public IntOption ensembleSizeOption = new IntOption("ensembleSize", 'S',
            "The number of base learners.", 1, 1, Integer.MAX_VALUE);  
       
    public FloatOption lambdaFixedOption = new FloatOption("lambdaFixed", 'L',
            "Max lambda value to use in Poisson distribution.", 6.0, 1.0, Float.MAX_VALUE);
    ...
    public IntOption maxDepthOption = new IntOption("maxDepth", 'd',
            "Maximum depth of the tree.", 32, 1,
            Integer.MAX_VALUE); 
    ...
    public IntOption awakeningOption = new IntOption("awakening", 'a',
            "For how many samples to apply the Spaced Learning heuristic.", 1000, 1, Integer.MAX_VALUE);
