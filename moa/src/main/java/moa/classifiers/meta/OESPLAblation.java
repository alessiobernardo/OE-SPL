...
/**
 * OnlineEnsembleSpacedLearningAblation
 *
 * <p>Oversampling (faster learning) until the base learner trees are still learning, 
 * undersampling (stop learning) when the base learner trees are not growing anymore.</p>
 *
 ...
 * @version $Revision: 1 $
 */
public class OESPLAblation extends AbstractClassifier implements MultiClassClassifier,CapabilitiesHandler {
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
        if (this.getClass() == OESPLAblation.class)
